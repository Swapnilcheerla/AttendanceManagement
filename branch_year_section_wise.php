...
{
// <................  section ..............>
$SECTION_sql = "SELECT count(hour".$select_hour.") FROM year".$year_select."_daily_attendance where hour".$select_hour."=1 and  date="."'".$date."' and student_section='".$section[$i]."'";
...
$average=($section_avg/$total_count)*100;
$avg[$i]=$average;
                ...
                <ul class="nav navbar-nav">
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="branch_year_section_wise.php" id="modal-btn">Branch-section-wise</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
...
var chart = new CanvasJS.Chart("chartContainer", {
    ...
    theme: "light2",
    title:{
        text: "<?php echo strtoupper($dbname); echo" YEAR-";echo$year_select ?> SECTION WISE ATTENDANCE ON  <?php echo date('d-m-Y')?>"
    },
    legend:{
        cursor: "pointer",
