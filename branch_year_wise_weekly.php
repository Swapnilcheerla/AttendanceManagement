...
for($i=3;$i<=3;$i++)
{
$presenties_sql = "SELECT count(hour".$select_hour.") FROM year".$i."_daily_attendance where hour".$select_hour."=1 and date BETWEEN '".$last_week_day."' AND '".$present_date."'";
//echo $presenties_sql;
...
$no_days_sql = "SELECT count(DISTINCT date) FROM year".$i."_daily_attendance where date BETWEEN '".$last_week_day."' AND '".$present_date."'";
...
$dataPoints1 = array(
	array("label"=> "FIRST_YEAR", "y"=> 36.12),
	array("label"=> "SECOND_YEAR", "y"=> 34.87),
	array("label"=> "THIRD_YEAR", "y"=> 40.30),
	array("label"=> "FOURTH_YEAR", "y"=> 35.30)
);
$dataPoints2 = array(
	array("label"=> "FIRST_YEAR", "y"=> 64.61),
	array("label"=> "SECOND_YEAR", "y"=> 70.55),
	array("label"=> "THIRD_YEAR", "y"=> 72.50),
	array("label"=> "FOURTH_YEAR", "y"=> 81.30)
);
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="weeklybranchyear.php">Branch-hour-wise</a></li>
                            <li><a href="weeklybranchyearsection.php">Branch-year-wise</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	theme: "light2",
	title:{
		text: "<?php echo strtoupper($select_branch) ?> WEEKLY YEAR WISE  ATTENDANCE"
	},
	legend:{
		cursor: "pointer",
