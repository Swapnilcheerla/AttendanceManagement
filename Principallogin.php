...
if($_POST){
  ...
  $sql = "SELECT p_id,p_name,p_email,p_pass FROM principal_info where p_email='".$_POST["username"]."'";
  $result = $conn->query($sql);
  if ($result->num_rows > 0) {
      $password=MD5($_POST["password"]);
      while($row = $result->fetch_assoc()) {
          if($row["p_pass"]==$password){
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="index.html">Principal Login </a>
                    </li>
                    <li class="active">
  ...
  <h4><strong>PRINCIPAL LOGIN</strong></h4>
  <form method="post" >
    ...
    <button type="submit" class="btn btn-primary" id="hlgsub">LOGIN</button>
  </form>
</div>
<br>
