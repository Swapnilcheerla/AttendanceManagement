...
//echo "count= ".$c."\n";
$no_days_sql = "SELECT count(DISTINCT date) FROM year".$year_select."_daily_attendance where date BETWEEN '".$month_start."' AND '".$present_date."'";
...
{
// <................  section ..............>
$SECTION_sql = "SELECT count(hour".$select_hour.") FROM year".$year_select."_daily_attendance where hour".$select_hour."=1 and date BETWEEN '".$month_start."' AND '".$present_date."' and student_section='".$section[$i]."'";
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="monthlybranchyear.php">Branch-hour-wise</a></li>
                            <li><a href="monthlybranchyearsection.php">Branch-year-wise</a></li>
                        </ul>
                    </li>
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	theme: "light2",
	title:{
		text: "<?php echo strtoupper($dbname)?> YEAR<?php echo $year_select?> MONTHLY SECTION WISE ATTENDANCE"
	},
	legend:{
		cursor: "pointer",
